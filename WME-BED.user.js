...
(function() {
    ...
    const TESTERS = ["The_Cre8r","jm6087"];
    ...
    function updateAlert() {
        ...
        let versionChanges = [
            SCRIPT_NAME + ' v' + SCRIPT_VERSION + ' Prerelease changes:',
            '- New Name!',
    ...
    function makeAdPin(x,y,logo,color) {
        log(`Make Ad Pin at https://www.waze.com/en-US/editor/?env=usa&lon=${x}&lat=${y}&zoom=${W.map.zoom}`)
